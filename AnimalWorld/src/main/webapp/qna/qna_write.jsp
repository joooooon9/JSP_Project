...
<span style="color: black; font-weight: bold;">▶QnA게시판 글작성</span><br><br><br>
<form action="qna_writeok.jsp" method="post" enctype="multipart/form-data" id="qnaw" onsubmit="return wsubmit();">
<!-- bkind = F>자유게시판, R>식품추천, S>나눔게시판, I>이미지갤러리 Q>qna게시판 -->
<input type="hidden" name="kind" id="kind" value="Q">
...
<button type="button" class="my_btn" onclick="location.href='qna_list.jsp'">돌아가기</button><br>
</div>                 
</form>
<!-- ----------------------------------------- 하단 카피라이트 인크루드 --------------------------------------------->
