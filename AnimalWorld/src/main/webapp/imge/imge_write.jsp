...
<script type="text/javascript">
	...
	function subwrite()
	{
		...
		$("#imgim").submit();
                ...
                <span style="color: black; font-weight: bold;">▶이미지게시판 글작성</span><br><br><br>
                <form action="imge_writeok.jsp" method="post" enctype="multipart/form-data" id="imgim" onsubmit="return wsubmit();">
                <!-- bkind = F>자유게시판, R>식품추천, S>나눔게시판, I>이미지갤러리 Q>qna게시판 -->
                <input type="hidden" name="kind" id="kind" value="I">
                <table border="1" style="margin: auto; width: 1000px;">
                    <tr>
                        <th style="width: 100px; background-color: aqua;">제목</th>
                        <td>
                            <input type="text" style="width: 99%; margin: auto;" name="title" id="title">
                        </td>
                    </tr>
                ...
                <p style="color: red; margin-left: 249px">[ 알림 ] 이미지 게시판에서 욕설 또는 비방글 등은 사전 경고 없이 관리자에 의하여 삭제 됩니다.</p>
				    ...
				    <div style="text-align: center; margin-top: 20px;">
				        ...
				        <button type="button" class="my_btn" onclick="location.href='imge_list.jsp'">돌아가기</button><br>
				    </div>                 
                </form>
<!-- ----------------------------------------- 하단 카피라이트 인크루드 --------------------------------------------->
