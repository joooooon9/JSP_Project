...
<span style="color: black; font-weight: bold;">▶QnA게시판 글수정</span><br><br><br>
<form action="qna_modifyok.jsp" method="post" id="modiok" enctype="multipart/form-data" onsubmit="return wsubmit();">
...
<p style="color: red; margin-left: 249px">[ 알림 ] QnA 게시판에서 욕설 또는 비방글 등은 사전 경고 없이 관리자에 의하여 삭제 됩니다.</p>
	...
	<input type="hidden" value="T" name="saveFlag" id="saveFlag">
	    ...
	    <button type="button" class="my_btn" onclick="location.href= 'qna_view.jsp?kind=R&page=<%= pageno %>&no=<%= vo.getBno()%> '">취소</button>
    </div>
</form>
